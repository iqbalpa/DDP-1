...
while cond2:
    ...
    # jika perintah adalah TUJUAN_KELAS_TERMURAH
        ...
        if (len(perintah) != 3) or (perintah[2] not in daftar_kelas): 
            ...
            for kelas in daftar_kelas:
                ...
                if kelas == perintah[2]:
                    ...
                    # mencari KA harga termurah sesuai dengan tujuan dan kelas permintaan user
                    daftar_kelas[kelas] = list(daftar_kelas[kelas])
                    termurah = daftar_kelas[kelas][0][3]
                    for (nomor,tujuan,jam,harga) in daftar_kelas[kelas]:
                        if tujuan == perintah[1]:
                            if termurah >= harga:
                                termurah = harga
                    ...
                    # menampilkan KA harga termurah sesuai dengan tujuan dan kelas permintaan user
                    else:
                        for (nomor,tujuan,jam,harga) in daftar_kelas[kelas]:
                            if harga == termurah:
                                print(f"KA {nomor} berangkat pukul {jam} dengan harga tiket {harga}")
    ...
    # jika perintah adalah TUJUAN_JAM_TERMURAH
        ...
        if len(perintah) != 3:
            ...
            # mencari KA harga termurah sesuai dengan tujuan dan jam permintaan user
            jadwal = list(jadwal)
            termurah = jadwal[0][3]
            for (nomor,tujuan,jam,harga) in jadwal:
                if (tujuan == perintah[1]) and (int(jam) <= int(perintah[2])):
            ...
            # menampilkan KA harga termurah sesuai dengan tujuan dan jam permintaan user
            else:
                for (nomor,tujuan,jam,harga) in jadwal:
                    if (tujuan == perintah[1]) and (int(jam) <= int(perintah[2])) and (harga == termurah):
                        print(f"KA {nomor} berangkat pukul {jam} dengan harga tiket {harga}")
